...
from dueling_dqn_model import DuelingQNetwork
...
class PrioritizedReplayBuffer:
    ...
    def sample(self):
        ...
        return (states, actions, rewards, next_states, dones, indexes, importance_sampling_weights)

    def update_priorities(self, indexes, loss):
        for i in indexes:
            self.priorities[i] = loss
